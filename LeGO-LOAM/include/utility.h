...
// VLP-16
extern const int N_SCAN = 16;         //线束
extern const int Horizon_SCAN = 1800; //一圈的扫描点数
extern const float ang_res_x = 0.2;   //
extern const float ang_res_y = 2.0;
extern const float ang_bottom = 15.0 + 0.1; //到最底下线束的垂直角度差
extern const int groundScanInd = 7;         //地面上的线束
